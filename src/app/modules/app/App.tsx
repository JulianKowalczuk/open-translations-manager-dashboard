...
import { CreatePhraseModal, PhrasesPanel } from 'app/modules/phrases';
import { fetchPhrasesAction, FetchPhrasesAction } from 'app/modules/phrases/phrasesStore';
import {
  FetchPhraseCategoriesAction,
  fetchPhrasesCategoriesAction
} from 'app/modules/phrasesCategories/phrasesCategoriesStore';
import { SettingsDrawer } from 'app/modules/settings';
